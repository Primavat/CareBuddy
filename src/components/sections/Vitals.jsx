...
const Vitals = () => {
    const [vitals, setVitals] = useState([
        { id: 1, name: 'Blood Pressure', value: '120/80', unit: 'mmHg', icon: Heart, color: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/20' },
        { id: 2, name: 'Heart Rate', value: '72', unit: 'BPM', icon: Activity, color: 'text-primary', bg: 'bg-primary/10 dark:bg-primary/20' },
        { id: 3, name: 'SpO2 Level', value: '98', unit: '%', icon: Thermometer, color: 'text-amber-500', bg: 'bg-amber-50 dark:bg-amber-900/20' },
        { id: 4, name: 'Glucose', value: '95', unit: 'mg/dL', icon: Droplet, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/20' },
    ]);
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="mb-14 flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-border">
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                {vitals.map((s, i) => (
                    <motion.div
                        ...
                        className="bg-card-bg p-6 rounded-[2.5rem] border border-border flex flex-col items-center text-center group hover:border-primary transition-all shadow-sm"
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-bg-main border-2 border-dashed border-border rounded-[3rem] p-10 flex flex-col items-center justify-center text-center">
                    <div className="w-16 h-16 bg-card-bg shadow-xl rounded-2xl flex items-center justify-center mb-6 text-primary border border-border">
                        <Activity size={32} />
                    </div>
