    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <AnimatePresence>
                    {members.map((member, index) => (
                        <motion.div
                            ...
                            className="bg-card-bg p-8 rounded-[2.5rem] border border-border shadow-sm hover:shadow-xl hover:border-primary transition-all group relative overflow-hidden"
                        >
                            <div className="flex items-center gap-5 mb-6">
                                <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-border group-hover:border-primary transition-colors bg-gray-50 dark:bg-bg-main">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div className="bg-gray-50 dark:bg-bg-main p-3 rounded-2xl text-center">
                ...
                {members.length === 0 && (
                    <div className="col-span-full py-20 text-center border-2 border-dashed border-border rounded-[3rem] bg-gray-50 dark:bg-bg-main">
